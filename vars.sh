...
# test seeds
# funder seed address (root account seed):
export FUNDER_SEED=SCEIO4XV4UFZEVFAWOWCSXUA32LKLKG5MLJ5R7FVCGVSLFTIHP3A35E7
export FUNDER_ADDRESS=GAKO7MWMPUJ6OID3T3ZN2O3TMQS3TPXF77HBA537SDIVHO4NKOR7VTN2

export CHANNEL_SEED=$FUNDER_SEED

export WHITELIST_SEED=SDZY6FTMSZZF35CSHUZNCXTRZK4Q3QG7MX6PHJDCKOANXBGZVV7STZJ5
export WHITELIST_ADDRESS=GDTOCLZWZETROTVYR5J4CY23VWCTS4YAOD66VIWEDM2WRP3OVKZUA76I

export WHITELISTED_SEED=$FUNDER_SEED
export WHITELISTED_ADDRESS=$FUNDER_ADDRESS
